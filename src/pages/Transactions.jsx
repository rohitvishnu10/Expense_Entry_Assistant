...
export default function Transactions() {
  ...
  return (
    <>
      <Navbar />
      <Box height={30} />
      <Box sx={{ display: "flex", backgroundColor: "#171b2c", color: "white" }}>
        <Sidenav />
        <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
                  ...
                  <TableBody>
                    {initialRows1.map((row, index) => (
                      <TableRow key={index} style={{ backgroundColor: "#1e1e1e" }}>
                        <TableCell style={{ fontSize:"15px",color: "white" }}>{row.eid}</TableCell>
                        <TableCell style={{ fontSize:"15px",color: "white" }}>{row.accepted ? 'Accepted' : 'Pending'}</TableCell>
                        ...
                        <TableCell style={{ fontSize:"15px",color: "white" }}>
          ...
          <Dialog
            ...
            maxWidth="md"
          >
            <DialogTitle style={{ fontSize: "2rem", backgroundColor: "#171b2c", color: "white" }}>Details</DialogTitle>
            <DialogContent style={{ fontSize: "1.2rem", backgroundColor: "#171b2c", color: "white" }}>
              {selectedRow && (
                <div style={{ display: "grid", gridTemplateColumns: "max-content auto", gap: "30px" }}>
                  <div style={{ fontWeight: "bold" ,color: "white"}}>Email ID:</div>
            ...
            <DialogActions>
              <Button style={{ color:"white",paddingLeft: "10px", backgroundColor: "#171b2c" }} onClick={handleCloseDialog} color="primary">
                Close
              </Button>
            </DialogActions>
          </Dialog>
